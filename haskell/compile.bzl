...
def _dynamic_target_metadata_impl(actions, output, arg, pkg_deps) -> list[Provider]:
    ...
    packages_info = get_packages_info(
        ...
        use_empty_lib = True, #use_empty_lib,
        for_deps = False, #for_deps,
        pkg_deps = pkg_deps,
    )
...
def compile_args(
    ...
    print("exposed_package_args = {}".format(packages_info.exposed_package_args))
    #print("packagedb_args = {}".format(packages_info.packagedb_args))
